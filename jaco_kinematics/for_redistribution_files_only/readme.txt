Packaging and Deploying jaco_kinematics
...
2. Installing the jaco_kinematics Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   jaco_kinematics. If you do not have write permissions, copy all its contents to a 
...
3. Using the jaco_kinematics Package

The jaco_kinematics package is on your Python path. To import it into a Python script or 
   session, simply execute:

    import jaco_kinematics
